...
public class ProcessRequestTest {
	...
	void testGetUserName() {
		processRequest.setUsername("Raj");
		assertEquals("Raj", processRequest.getUsername());
	}
	...
	void testConstructor() {
		ProcessRequest pr = new ProcessRequest(101, "Raj", 987456123, 1234567890, "integral", "laptop", 1, true);
		assertEquals(101,pr.getUserID());
		assertEquals("Raj",pr.getUsername());
	...
	void testConstructorForAccessory() {
		ProcessRequest pr = new ProcessRequest(101, "Raj", 987456123, 1234567890, "accessory", "laptop", 1, true);
		assertEquals(101,pr.getUserID());
		assertEquals("Raj",pr.getUsername());
		assertEquals(987456123,pr.getContactNumber());
		assertEquals(1234567890,pr.getCreditCardNumber());
	...
	void testConstructorNoPriority() {
		ProcessRequest pr = new ProcessRequest(101, "Raj", 987456123, 1234567890, "integral", "laptop", 1, false);
		assertEquals(101,pr.getUserID());
		assertEquals("Raj",pr.getUsername());
		assertEquals(987456123,pr.getContactNumber());
		assertEquals(1234567890,pr.getCreditCardNumber());
	...
	void testConstructorAccessoryNoPriority() {
		ProcessRequest pr = new ProcessRequest(101, "Raj", 987456123, 1234567890, "accessory", "laptop", 1, false);
		assertEquals(101,pr.getUserID());
		assertEquals("Raj",pr.getUsername());
		assertEquals(987456123,pr.getContactNumber());
		assertEquals(1234567890,pr.getCreditCardNumber());
