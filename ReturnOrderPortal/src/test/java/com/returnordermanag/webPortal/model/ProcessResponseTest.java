...
public class ProcessResponseTest {
	...
	void testGetDateOfDelivery() {
		processResponse.setDateOfDelivery("13/04/2021");
		assertEquals("13/04/2021", processResponse.getDateOfDelivery());
	}
	...
	void testConstructor() {
		ProcessResponse pres = new ProcessResponse(11, 1, 500.0, 500.0, "13/04/2021");
		...
		assertEquals("13/04/2021",pres.getDateOfDelivery());
	}
}