...
//@RestControllerAdvice annotation tells a controller that the object returned is automatically 
//serialized into JSON and passed it to the HttpResponse object @RestControllerAdvice = @ControllerAdvice + @ResponseBody
