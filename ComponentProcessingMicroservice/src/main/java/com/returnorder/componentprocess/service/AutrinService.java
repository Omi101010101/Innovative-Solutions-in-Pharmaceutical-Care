...
@Slf4j
@Service
public class AutrinService implements ProcessService {
	
	static Logger logger = LoggerFactory.getLogger(AutrinService.class);
	...
	public ProcessResponse processDetail(int userID) {
		...
		//packagingAndDeliveryCharge =processRequest.getPackagingAndDeliveryCharge(componentType,
			//	quantity);
